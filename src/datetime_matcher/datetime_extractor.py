...
class DatetimeExtractor:
    ...
    # public
    def extract_datetimes(self, datetime_extractor_regex: str, tokens: List[DfregexToken], text: str, count: int = 0) -> Iterable[Optional[datetime]]:
    ...
    # private
    def __finditer_with_limit(self, regex: str, text: str, count: int) -> Iterable[Match[str]]:
        # Use regex to iterate over all matches
    ...
    # private
    def __parse_match_into_maybe_datetime(self, match: Match[str], df_tokens: List[DfregexToken]) -> Optional[datetime]:
